...
module.exports = function webroute(
    ...
    // basicRoleAccess (used for controller access)
    options.config.plugins.basicRoleAccess = options.basicRoleAccess;
    delete options.basicRoleAccess;

    // tmpAccess (used for login and role check)
    options.config.plugins.tmpAccess = options.tmpAccess;
    delete options.tmpAccess;
